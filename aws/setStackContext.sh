...
DRYRUN="${LEVEL_PREFIX}${DEPLOYMENT_UNIT_PREFIX}${DEPLOYMENT_UNIT_SUBSET_PREFIX}${REGION_PREFIX}dryrun.json"
if [[ ! -f "${CF_DIR}/${TEMPLATE}" ]]; then
    ...
    DRYRUN="${LEVEL_PREFIX}${DEPLOYMENT_UNIT_PREFIX}${DEPLOYMENT_UNIT_SUBSET_PREFIX}${ACCOUNT_PREFIX}${REGION_PREFIX}dryrun.json"
fi
