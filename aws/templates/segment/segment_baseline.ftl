    ...
    [#list requiredOccurrences(
        ...
        [#list occurrence.Occurrences![] as subOccurrence]
            ...
            [#if subCore.Type == BASELINE_DATA_COMPONENT_TYPE ]
                ...
                [#assign bucketBaselineDeployment = subResources["bucket"].BaselineDeployment ]

                [#if ( deploymentSubsetRequired(BASELINE_COMPONENT_TYPE) && !isPartOfDeploymentUnit(bucketId, deploymentUnit, "s3")) || 
                       ( deploymentSubsetRequired("s3", true) && isPartOfCurrentDeploymentUnit(bucketId )) ]
