...
[#if (componentType == "userpool") && deploymentSubsetRequired("userpool", true)]
    ...
    [#assign userPoolIdentityUnAuthRoleId = formatIdentityPoolUnAuthRoleId(userPoolIdentityPoolId)]
    [#assign userPoolIdentityAuthRoleId = formatIdentityPoolAuthRoleId(userPoolIdentityPoolId)]
    [#assign userPoolIdentityRoleMappingId = formatIdentityPoolRoleMappingId(userPoolIdentityPoolId)]
