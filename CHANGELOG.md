...
* (template): add parameter extension macro ([#1701](https://github.com/roleyfoley/engine/issues/1701))
* input qualification ([#1695](https://github.com/roleyfoley/engine/issues/1695))
* add management port configuration to compute
* (ecs): extend placement strategy support
* set SES inbound active ruleset ([#1694](https://github.com/roleyfoley/engine/issues/1694))
...
* remove explicit qualification support ([#1696](https://github.com/roleyfoley/engine/issues/1696))

Full set of changes: [`8.1.2...8900b1d`](https://github.com/roleyfoley/engine/compare/8.1.2...8900b1d)
...
* make refresh input state routine public ([#1669](https://github.com/roleyfoley/engine/issues/1669))
...
* add storage profile configuration ([#1642](https://github.com/roleyfoley/engine/issues/1642))
...
* compute tasks
* add image configuration support for vms ([#1627](https://github.com/roleyfoley/engine/issues/1627))
* add attirbutes during extension processing ([#1625](https://github.com/roleyfoley/engine/issues/1625))
* (apigateway): image sourcing support ([#1622](https://github.com/roleyfoley/engine/issues/1622))
* (schema): add layers to the valid schema sections ([#1618](https://github.com/roleyfoley/engine/issues/1618))
* (cd): install the latest hamlet for testing
* adds mount path to volume config
* add support for engine output writing ([#1583](https://github.com/roleyfoley/engine/issues/1583))
* (sqs): ordering configuration for sqs queues
* validate deployment mode provided ([#1576](https://github.com/roleyfoley/engine/issues/1576))
* add occurrences entrance ([#1578](https://github.com/roleyfoley/engine/issues/1578))
* deployment state reporting ([#1574](https://github.com/roleyfoley/engine/issues/1574))
* (userpool): add schema attribute constraints ([#1564](https://github.com/roleyfoley/engine/issues/1564))
* ipaddressgroups on bastion component ([#1567](https://github.com/roleyfoley/engine/issues/1567))
* (gateway): add dpd action configuration
* Stop on fatal ([#1556](https://github.com/roleyfoley/engine/issues/1556))
* refactor input sources ([#1549](https://github.com/roleyfoley/engine/issues/1549))
* additional wrapper search options ([#1553](https://github.com/roleyfoley/engine/issues/1553))
* add schema generation for modules ([#1550](https://github.com/roleyfoley/engine/issues/1550))
* (jenkins): handle plugin upgrades ([#1543](https://github.com/roleyfoley/engine/issues/1543))
* whatif input provider ([#1538](https://github.com/roleyfoley/engine/issues/1538))
* add raw ids for occurrence details ([#1539](https://github.com/roleyfoley/engine/issues/1539))
* layerpath attributeset ([#1537](https://github.com/roleyfoley/engine/issues/1537))
* (baseline): add support for extensions on keys ([#1533](https://github.com/roleyfoley/engine/issues/1533))
* wrapper upgrade ([#1530](https://github.com/roleyfoley/engine/issues/1530))
* linkChildConfiguration to attributeSet attrs
* (s3): add support for inventory reports
* (spa): image source from url ([#1522](https://github.com/roleyfoley/engine/issues/1522))
* (userpool): authprovider extensions ([#1521](https://github.com/roleyfoley/engine/issues/1521))
...
* (externalnetwork): Alerting support ([#1515](https://github.com/roleyfoley/engine/issues/1515))
* (template): url image sourcing ([#1513](https://github.com/roleyfoley/engine/issues/1513))
* (s3): add s3vpcaccess extension
* changelog generation ([#1509](https://github.com/roleyfoley/engine/issues/1509))
* (registry): support for mutli region registry
* globaldb secondary indexes ([#1507](https://github.com/roleyfoley/engine/issues/1507))
...
* (ecs): support container image sourcing ([#1495](https://github.com/roleyfoley/engine/issues/1495))
* (alerts): get metric dimensions from blueprint ([#1490](https://github.com/roleyfoley/engine/issues/1490))
* (secretstore): update configuration and make it shareable ([#1484](https://github.com/roleyfoley/engine/issues/1484))
...
* (lambda): pull images from external source ([#1456](https://github.com/roleyfoley/engine/issues/1456))
...
* semver support ([#1434](https://github.com/roleyfoley/engine/issues/1434))
...
* add databucket replication attributes ([#1411](https://github.com/roleyfoley/engine/issues/1411))
* add support for token validity expressions ([#1409](https://github.com/roleyfoley/engine/issues/1409))
* (links): incl. support for case-insensitive link direction
* "Account" and fixed build scope ([#1402](https://github.com/roleyfoley/engine/issues/1402))
...
* (schema): add required property to jsonschemas ([#1367](https://github.com/roleyfoley/engine/issues/1367))
...
* tier based network lookup ([#1359](https://github.com/roleyfoley/engine/issues/1359))
...
* (privateservice): intial support for private services ([#1330](https://github.com/roleyfoley/engine/issues/1330))
...
* (globaldb): intial support for global dbs ([#1325](https://github.com/roleyfoley/engine/issues/1325))
* (fragment): startup command setting for agent
* (jenkins): add support for permanent ecs agents ([#1321](https://github.com/roleyfoley/engine/issues/1321))
* (apigateway): support gateway and cdn https profiles
* (mobileapp): OTA Support on CDN routes ([#1319](https://github.com/roleyfoley/engine/issues/1319))
...
* region in filenames ([#1667](https://github.com/roleyfoley/engine/issues/1667))
* typo in description
* minor spelling mistake fixes
* dynamic cmdb loading ([#1663](https://github.com/roleyfoley/engine/issues/1663))
* set multiAZ flag for blueprint generation ([#1662](https://github.com/roleyfoley/engine/issues/1662))
* typo in definition
* typo in definition
* log format message
* script store sync ([#1647](https://github.com/roleyfoley/engine/issues/1647))
* mta rule link attribute
* default storage profile name
* certificate behaviour configuration ([#1641](https://github.com/roleyfoley/engine/issues/1641))
* handle attribute formats in expand
* align alternative config with gen contract
* update state output to align with output
* pseudo stacks ([#1628](https://github.com/roleyfoley/engine/issues/1628))
* use loaded providers as definitive providers ([#1623](https://github.com/roleyfoley/engine/issues/1623))
* handle multiple load modules in module ([#1621](https://github.com/roleyfoley/engine/issues/1621))
* composite object wildcard handling ([#1614](https://github.com/roleyfoley/engine/issues/1614))
* loader module control ([#1620](https://github.com/roleyfoley/engine/issues/1620))
...
* output naming for deployment group prefix ([#1606](https://github.com/roleyfoley/engine/issues/1606))
* typo in blueprint generation
* schema output return
* disable qualifier transformer
* shared test seeder
* shared fixture seeder
* isolate testing to only include local code ([#1594](https://github.com/roleyfoley/engine/issues/1594))
* update layer type for region
* deploymentGroup validation
* (sqs): typo in id details
* define deploymentgroups for schemas ([#1586](https://github.com/roleyfoley/engine/issues/1586))
* regression in unlist generation
* RawId and Name values for subcomponents ([#1585](https://github.com/roleyfoley/engine/issues/1585))
* handle empty deployment unit Ids unitlist
* handle missing product domain ([#1580](https://github.com/roleyfoley/engine/issues/1580))
* update hamlet cli test cmds ([#1575](https://github.com/roleyfoley/engine/issues/1575))
* domain assembly process ([#1573](https://github.com/roleyfoley/engine/issues/1573))
* domain zone configuration ([#1572](https://github.com/roleyfoley/engine/issues/1572))
* handling of log level lookup ([#1569](https://github.com/roleyfoley/engine/issues/1569))
* allow for loading provider input replacement
* internaltest component definition ([#1547](https://github.com/roleyfoley/engine/issues/1547))
* Links as subobjects ([#1545](https://github.com/roleyfoley/engine/issues/1545))
* freemarker wrapper write functions ([#1542](https://github.com/roleyfoley/engine/issues/1542))
* (account): update script store clone setup ([#1541](https://github.com/roleyfoley/engine/issues/1541))
* image url override for containerregistry ([#1534](https://github.com/roleyfoley/engine/issues/1534))
* flowlog configuration ([#1531](https://github.com/roleyfoley/engine/issues/1531))
* AttributeSet handling ([#1529](https://github.com/roleyfoley/engine/issues/1529))
* link attributeset in s3 inventory reports
* attributeset schema one per
* (schema): reference data as one schema per schema
* revert type updates ([#1520](https://github.com/roleyfoley/engine/issues/1520))
* corrected a missed composite object data type update ([#1519](https://github.com/roleyfoley/engine/issues/1519))
...
* dind hostname and image details ([#1503](https://github.com/roleyfoley/engine/issues/1503))
* erroneous bracket ([#1501](https://github.com/roleyfoley/engine/issues/1501))
* minor typos
...
* (s3): renamed global var back to dataOffline ([#1452](https://github.com/roleyfoley/engine/issues/1452))
* include int and version in occurrence caching ([#1451](https://github.com/roleyfoley/engine/issues/1451))
* provide deployment unit to build settings
* typo in function name
* semver supports asterisk in range indicator ([#1438](https://github.com/roleyfoley/engine/issues/1438))
* parameter ordering for invokeViewMacro ([#1428](https://github.com/roleyfoley/engine/issues/1428))
* allow for undefined networkendpoints on a region ([#1427](https://github.com/roleyfoley/engine/issues/1427))
* determine a primary provider to use for views ([#1422](https://github.com/roleyfoley/engine/issues/1422))
* authorizer failure messages
* 403 status on authorizer failure
* case insensitive token validity expression
* setup contract outputs in resourceset ([#1419](https://github.com/roleyfoley/engine/issues/1419))
...
* typo in openapi syntax ([#1410](https://github.com/roleyfoley/engine/issues/1410))
* syntax and variable name updates for build scopes ([#1403](https://github.com/roleyfoley/engine/issues/1403))
* Explicit mock API passthrough behaviour ([#1401](https://github.com/roleyfoley/engine/issues/1401))
* (ecs): reinstate deployment details ([#1400](https://github.com/roleyfoley/engine/issues/1400))
* (ecs): add fragment and instance back to container props ([#1399](https://github.com/roleyfoley/engine/issues/1399))
...
* (fragment): hamlet agent properties mounts ([#1397](https://github.com/roleyfoley/engine/issues/1397))
* remove legacy naming for fragment
* typos in fragments
* (ecs): Volume drivers and support for control over volume engine
* Pregeneration output format ([#1395](https://github.com/roleyfoley/engine/issues/1395))
* Output type for pregeneration scripts ([#1394](https://github.com/roleyfoley/engine/issues/1394))
* handle no deploymentunit ([#1392](https://github.com/roleyfoley/engine/issues/1392))
* (apigateway): do not attempt eval if definitions full is null ([#1389](https://github.com/roleyfoley/engine/issues/1389))
* remove unused deployment group config
* remove networkacl policies from iam links ([#1386](https://github.com/roleyfoley/engine/issues/1386))
...
* (networkProfile): enable or disable egress rules ([#1351](https://github.com/roleyfoley/engine/issues/1351))
...
* Remove auth provider defaults ([#1313](https://github.com/roleyfoley/engine/issues/1313))
...
* composite template inclusion ([#1613](https://github.com/roleyfoley/engine/issues/1613))
* remove startup scripts from masterdata
* run tests first for feedback
* state processing ([#1605](https://github.com/roleyfoley/engine/issues/1605))
* CLO accessor names
* command line and masterdata processing
* remove metric setup from core ([#1582](https://github.com/roleyfoley/engine/issues/1582))
* change timing log level ([#1571](https://github.com/roleyfoley/engine/issues/1571))
* move github templates to org ([#1557](https://github.com/roleyfoley/engine/issues/1557))
* attributesets to be def on comp obj
* remove unused global vars
* add error handling for invalid schema instance
* (schemaset): align task attributes ([#1523](https://github.com/roleyfoley/engine/issues/1523))
...
* switch COT to Hamlet ([#1413](https://github.com/roleyfoley/engine/issues/1413))
...
* overhaul and revision of outdated readme ([#1566](https://github.com/roleyfoley/engine/issues/1566))
* Add basic README for shared extensions ([#1554](https://github.com/roleyfoley/engine/issues/1554))
#### Others

* changelog update
* (deps): bump lodash from 4.17.20 to 4.17.21 ([#1682](https://github.com/roleyfoley/engine/issues/1682))
* (deps): bump handlebars from 4.7.6 to 4.7.7 ([#1680](https://github.com/roleyfoley/engine/issues/1680))
* (deps): bump hosted-git-info from 2.8.8 to 2.8.9 ([#1681](https://github.com/roleyfoley/engine/issues/1681))
* add node 14 support for lambda ([#1638](https://github.com/roleyfoley/engine/issues/1638))
* (schemas): add layer schemas to schemaset ([#1633](https://github.com/roleyfoley/engine/issues/1633))
* release notes
* changelog
* changelog
